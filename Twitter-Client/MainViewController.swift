...
class MainViewController: UITableViewController {
    ...
    func getFollowers(userID: String, cursor: String)
    {
            ...
            do {
                if data != nil
                {
                    ...
                    if let j: AnyObject = json {
                        ...
                        {
                            self.getFollowers(userID, cursor: (response?.next_cursor_str)!)
                        }
                    }
                }
    ...
    override func viewDidLoad() {
        ...
        if((lastSession()) != nil)
        {
            //getFollowers((lastSession()?.userID)!, cursor: "-1")
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let URL = NSURL(string: followers[indexPath.row].profile_image_url)!
        let placeholderImage = UIImage(named: "Placeholder")!
        cell.profileImageView!.af_setImageWithURL(URL, placeholderImage: placeholderImage)
